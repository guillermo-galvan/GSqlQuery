...
namespace FluentSQL.SearchCriteria
{
    public static class LessThanExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> LessThan<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndLessThan<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrLessThan<T, TReturn, TDbConnection, TResult, TProperties>
