...
namespace GSqlQuery.Test.SearchCriteria
{
    public class LessThanOrEqualTest
    {
        ...
        public void Should_create_an_instance()
        {
            ...
            LessThanOrEqual<Test1, int> equal = new LessThanOrEqual<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), 1, null, ref dynamicQuery);
        ...
        {
            var dynamicQuery = _dynamicQuery;
            LessThanOrEqual<Test1, int> equal = new LessThanOrEqual<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), value, logicalOperator, ref dynamicQuery);
