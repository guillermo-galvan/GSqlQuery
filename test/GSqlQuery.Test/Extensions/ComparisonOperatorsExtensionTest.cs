...
namespace GSqlQuery.Test.Extensions
{
    public class ComparisonOperatorsExtensionTest
    {
        ...
        {
            var query = Entity<Test1>.Select(new DefaultFormats()).LeftJoin<Test3>().NotEqual(x => x.Table2.Ids, x => x.Table1.Id).Build();
        ...
        {
            var query = Entity<Test1>.Select(new DefaultFormats()).LeftJoin<Test3>().GreaterThan(x => x.Table2.Ids, x => x.Table1.Id).Build();
        ...
        {
            var query = Entity<Test1>.Select(new DefaultFormats()).LeftJoin<Test3>().LessThan(x => x.Table2.Ids, x => x.Table1.Id).Build();
        ...
        {
            var query = Entity<Test1>.Select(new DefaultFormats()).LeftJoin<Test3>().GreaterThanOrEqual(x => x.Table2.Ids, x => x.Table1.Id).Build();
        ...
        {
            var query = Entity<Test1>.Select(new DefaultFormats()).LeftJoin<Test3>().LessThanOrEqual(x => x.Table2.Ids, x => x.Table1.Id).Build();
