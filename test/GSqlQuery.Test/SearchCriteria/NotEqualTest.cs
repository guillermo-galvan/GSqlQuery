...
namespace GSqlQuery.Test.SearchCriteria
{
    public class NotEqualTest
    {
        ...
        {
            NotEqual<int> test = new NotEqual<int>(_classOptionsTupla, new DefaultFormats(), 1);
        ...
        {
            NotEqual<int> test = new NotEqual<int>(_classOptionsTupla, new DefaultFormats(), value, logicalOperator);
