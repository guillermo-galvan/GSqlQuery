...
namespace GSqlQuery.Runner.Test
{
    ...
    internal static class LoadGSqlQueryOptions
    {
        public static IDatabaseManagement<IDbConnection> GetDatabaseManagmentMock()
        {
            ...
            mock.Setup(x => x.ExecuteReader<Test1>(It.IsAny<IDbConnection>(), It.IsAny<IQuery>(), It.IsAny<IEnumerable<PropertyOptions>>(), It.IsAny<IEnumerable<IDataParameter>>()))
        ...
        public static IDatabaseManagement<IDbConnection> GetDatabaseManagmentMockAsync()
        {
            ...
            mock.Setup(x => x.ExecuteReaderAsync<Test1>(It.IsAny<IDbConnection>(), It.IsAny<IQuery>(), It.IsAny<IEnumerable<PropertyOptions>>(), It.IsAny<IEnumerable<IDataParameter>>(), It.IsAny<CancellationToken>()))
