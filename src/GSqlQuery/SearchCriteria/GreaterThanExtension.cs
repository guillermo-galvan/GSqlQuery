...
namespace GSqlQuery
{
    public static class GreaterThanExtension
    {
            ...
            where T : class where TReturn : IQuery<T>
        {
            ...
            andor.Add(new GreaterThan<TProperties>(columnInfo, where.Formats, value));
            return andor;
        }
            ...
            TProperties value) where T : class where TReturn : IQuery<T>
        {
            ...
            var columnInfo = expression.GetColumnAttribute();
            andOr.Add(new GreaterThan<TProperties>(columnInfo, andOr.Formats, value, "AND"));
            return andOr;
        }
            ...
            TProperties value) where T : class where TReturn : IQuery<T>
        {
            andOr.Validate(expression);
            var columnInfo = expression.GetColumnAttribute();
            andOr.Add(new GreaterThan<TProperties>(columnInfo, andOr.Formats, value, "OR"));
            return andOr;
        }
    }
}