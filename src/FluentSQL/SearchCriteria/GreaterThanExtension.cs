...
namespace FluentSQL.SearchCriteria
{
    public static class GreaterThanExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> GreaterThan<T, TReturn, TDbConnection, TResult, TProperties>(this IWhere<T, TReturn, TDbConnection, TResult> where,
            Expression<Func<T, TProperties>> expression, TProperties value)
            where T : class, new() where TReturn : IQuery
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndGreaterThan<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value/param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrGreaterThan<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            TProperties value) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
