...
namespace GSqlQuery.Test.SearchCriteria
{
    public class NotBetweenTest
    {
        ...
        {
            NotBetween<Test1, int> equal = new NotBetween<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), 1, 2, null, _dynamicQuery);
        ...
        {
            NotBetween<Test1, int> equal = new NotBetween<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), initValue, finalValue, logicalOperator, _dynamicQuery);
        ...
        {
            NotBetween<Test1, int> equal = new NotBetween<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), inicialValue, finalValue, logicalOperator, _dynamicQuery);
