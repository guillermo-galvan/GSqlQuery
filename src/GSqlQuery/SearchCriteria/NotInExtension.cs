...
namespace GSqlQuery
{
    public static class NotInExtension
    {
           ...
           where TQueryOptions : QueryOptions
        {
            ...
            NotIn<T, TProperties> equal = new NotIn<T, TProperties>(ClassOptionsFactory.GetClassOptions(typeof(T)), formats, values, logicalOperator, ref func);
            andOr.Add(equal);
        }
        ...
        public static IAndOr<T, TReturn, TQueryOptions> OrNotIn<T, TReturn, TQueryOptions, TProperties>(this IAndOr<T, TReturn, TQueryOptions> andOr, Expression<Func<T, TProperties>> func, IEnumerable<TProperties> values)
            ...
            where TQueryOptions : QueryOptions
        {
            CreateCriteria<T, TReturn, TQueryOptions, TProperties>(andOr, andOr.QueryOptions.Formats, ref func, values, Constants.OR);
            return andOr;
        }
    }
}