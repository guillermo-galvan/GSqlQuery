...
namespace GSqlQuery.Test.SearchCriteria
{
    public class NotEqualTest
    {
        ...
        public void Should_create_an_instance()
        {
            ...
            NotEqual<Test1, int> test = new NotEqual<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), 1, null, ref dynamicQuery);
        ...
        {
            var dynamicQuery = _dynamicQuery;
            NotEqual<Test1, int> test = new NotEqual<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), value, logicalOperator, ref dynamicQuery);
