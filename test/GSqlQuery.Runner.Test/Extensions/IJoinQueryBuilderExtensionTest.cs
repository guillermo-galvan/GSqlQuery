...
namespace GSqlQuery.Runner.Test.Extensions
{
    public class IJoinQueryBuilderExtensionTest
    {
        ...
        public void NotEqual_Join_Three_Table()
        {
            ...
            mock.Setup(x => x.ExecuteReader(It.IsAny<IQuery<Join<Test1, Test3, Test6>>>(), It.IsAny<PropertyOptionsCollection>()))
                .Returns<IQuery<Join<Test1, Test3, Test6>>, PropertyOptionsCollection>((q, p) =>
                {
            ...
            Assert.Empty(result);
            mock.Verify(x => x.ExecuteReader(It.IsAny<IQuery<Join<Test1, Test3, Test6>>>(), It.IsAny<PropertyOptionsCollection>()));
        }
