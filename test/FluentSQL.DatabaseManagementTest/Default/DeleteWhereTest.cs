...
namespace FluentSQL.DatabaseManagementTest.Default
{
    public class DeleteWhereTest
    {
        ...
        public DeleteWhereTest()
        {
            ...
            _deleteQueryBuilder = new DeleteQueryBuilder<Test1, DbConnection>(new ConnectionOptions<DbConnection>(new FluentSQL.Default.Statements(), LoadFluentOptions.GetDatabaseManagmentMock()));
        ...
        public void Should_build_the_criteria2()
        {
            ...
            var criteria = query.BuildCriteria(new FluentSQL.Default.Statements());
