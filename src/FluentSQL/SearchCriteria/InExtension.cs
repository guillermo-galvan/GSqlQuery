...
namespace FluentSQL.SearchCriteria
{
    public static class InExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> In<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="values">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndIn<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="values">Values</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrIn<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            IEnumerable<TProperties> values) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
