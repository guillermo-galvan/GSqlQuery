...
namespace FluentSQL.SearchCriteria
{
    public static class IsNullExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> IsNull<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndIsNull<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrIsNull<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression)
            where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
