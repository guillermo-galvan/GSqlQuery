...
namespace GSqlQuery.Test.Data
{
    internal class Inner_Join_two_tables_TestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,Test3.Create as Test3_Create,Test3.IsTests as Test3_IsTests,TableName.Id as Test6_Id,TableName.Name as Test6_Name,TableName.Create as Test6_Create,TableName.IsTests as Test6_IsTests FROM Test3 INNER JOIN TableName ON Test3.Id = TableName.Id;"
            };
    ...
    internal class Inner_Join_two_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create FROM Test3 INNER JOIN TableName ON Test3.Id = TableName.Id;"
            };
    ...
    internal class Left_Join_two_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create FROM Test3 LEFT JOIN TableName ON Test3.Id = TableName.Id;"
            };
    ...
    internal class Right_Join_two_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create FROM Test3 RIGHT JOIN TableName ON Test3.Id = TableName.Id;"
            };
    ...
    internal class Inner_Join_three_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create,Test1.IsTest as Test1_IsTest FROM Test3 INNER JOIN TableName ON Test3.Id = TableName.Id INNER JOIN Test1 ON TableName.Id = Test1.Id;"
            };
    ...
    internal class Left_Join_three_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create,Test1.IsTest as Test1_IsTest FROM Test3 LEFT JOIN TableName ON Test3.Id = TableName.Id LEFT JOIN Test1 ON TableName.Id = Test1.Id;"
            };
    ...
    internal class Right_Join_three_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new Statements(),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create,Test1.IsTest as Test1_IsTest FROM Test3 RIGHT JOIN TableName ON Test3.Id = TableName.Id RIGHT JOIN Test1 ON TableName.Id = Test1.Id;"
            };
