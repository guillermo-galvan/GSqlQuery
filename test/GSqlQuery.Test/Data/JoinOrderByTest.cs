...
namespace GSqlQuery.Test.Data
{
    ...
    internal class Inner_Join_OrderBy_two_tables_TestData2 : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new QueryOptions (new DefaultFormats()),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,TableName.Create as Test6_Create FROM Test3 INNER JOIN TableName ON Test3.Id = TableName.Id ORDER BY Test3.Name,Test3.Create,TableName.Name,TableName.Create DESC;"
            };

            yield return new object[]
            {
                new QueryOptions (new Models.Formats()),"SELECT [Test3].[Id] as [Test3_Id],[Test3].[Name] as [Test3_Name],[TableName].[Create] as [Test6_Create] FROM [Test3] INNER JOIN [TableName] ON [Test3].[Id] = [TableName].[Id] ORDER BY [Test3].[Name],[Test3].[Create],[TableName].[Name],[TableName].[Create] DESC;"
            };
        }
    ...
    internal class Inner_Join_OrderBy_three_tables_Where_In_TestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new QueryOptions (new DefaultFormats()),"SELECT Test3.Id as Test3_Id,Test3.Name as Test3_Name,Test3.Create as Test3_Create,Test3.IsTests as Test3_IsTests,TableName.Id as Test6_Id,TableName.Name as Test6_Name,TableName.Create as Test6_Create,TableName.IsTests as Test6_IsTests,Test1.Id as Test1_Id,Test1.Name as Test1_Name,Test1.Create as Test1_Create,Test1.IsTest as Test1_IsTest FROM Test3 INNER JOIN TableName ON Test3.Id = TableName.Id RIGHT JOIN Test1 ON TableName.Id = Test1.Id WHERE Test3.Id IN (@Param,@Param,@Param) AND TableName.Id NOT IN (@Param,@Param,@Param) ORDER BY Test1.Id,Test3.Name,Test3.IsTests,TableName.Name,TableName.IsTests ASC;"
            };
