...
namespace GSqlQuery.Test.SearchCriteria
{
    public class LessThanTest
    {
        ...
        public void Should_create_an_instance()
        {
            ...
            LessThan<Test1, int> equal = new LessThan<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), 1, null, ref dynamicQuery);
        ...
        {
            var dynamicQuery = _dynamicQuery;
            LessThan<Test1, int> equal = new LessThan<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), value, logicalOperator, ref dynamicQuery);
