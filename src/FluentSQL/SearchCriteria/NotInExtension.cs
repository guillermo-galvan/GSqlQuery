...
namespace FluentSQL.SearchCriteria
{
    public static class NotInExtension
    {
        ...
        public static IAndOr<T> NotIn<T, TProperties>(this IWhere<T> where, Expression<Func<T, TProperties>> expression, IEnumerable<TProperties> values) where T : class, new()
        {
        ...
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T> AndNotIn<T, TProperties>(this IAndOr<T> andOr, Expression<Func<T, TProperties>> expression, IEnumerable<TProperties> values) where T : class, new()
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T> OrNotIn<T, TProperties>(this IAndOr<T> andOr, Expression<Func<T, TProperties>> expression, IEnumerable<TProperties> values) where T : class, new()
        {
            andOr.Validate(expression);
