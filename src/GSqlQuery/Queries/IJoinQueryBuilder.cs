...
namespace GSqlQuery
{
    ...
    public interface IJoinQueryBuilder<T, TReturn, TOptions> : IQueryBuilderWithWhere<TReturn, TOptions>, IQueryBuilderWithWhere<T, TReturn, TOptions>, IOptions<TOptions>
        where T : class
