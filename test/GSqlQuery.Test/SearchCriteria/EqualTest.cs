...
namespace GSqlQuery.Test.SearchCriteria
{
    public class EqualTest
    {
        ...
        public void Should_create_an_instance()
        {
            ...
            Equal<Test1, int> test = new Equal<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), 1, null, ref dynamicQuery);
        ...
        {
            var dynamicQuery = _dynamicQuery;
            Equal<Test1, int> test = new Equal<Test1, int>(_classOptionsTupla.ClassOptions, new DefaultFormats(), value, logicalOperator, ref dynamicQuery);
