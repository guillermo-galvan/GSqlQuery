...
El método `Where` solo es accesible por las consultas [Select](Select.md), [Update](Update.md), [Delete](Delete.md), [Count](Count.md) y [Join](Join.md), dando la posibilidad de agregar el where en la consulta.
