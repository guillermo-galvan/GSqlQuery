...
namespace GSqlQuery
{
    public static class GreaterThanOrEqualExtension
    {
            ...
            TProperties value) where T : class where TReturn : IQuery<T>
        {
            ...
            andor.Add(new GreaterThanOrEqual<TProperties>(columnInfo.ClassOptions.Table, columnInfo.MemberInfo, value));
            return andor;
        }
            ...
            TProperties value) where T : class where TReturn : IQuery<T>
        {
            ...
            var columnInfo = expression.GetColumnAttribute();
            andOr.Add(new GreaterThanOrEqual<TProperties>(columnInfo.ClassOptions.Table, columnInfo.MemberInfo, value, "AND"));
            return andOr;
        }
            ...
            TProperties value) where T : class where TReturn : IQuery<T>
        {
            andOr.Validate(expression);
            var columnInfo = expression.GetColumnAttribute();
            andOr.Add(new GreaterThanOrEqual<TProperties>(columnInfo.ClassOptions.Table, columnInfo.MemberInfo, value, "OR"));
            return andOr;
        }
    }
}