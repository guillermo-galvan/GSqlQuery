...
namespace FluentSQL.SearchCriteria
{
    public static class NotEqualExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> NotEqual<T, TReturn, TDbConnection, TResult, TProperties>
            (this IWhere<T, TReturn, TDbConnection, TResult> where, Expression<Func<T, TProperties>> expression, TProperties value)
            where T : class, new() where TReturn : IQuery
        {
        ...
        /// <param name="value">Value for equality</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndNotEqual<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value for equality/param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrNotEqual<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            TProperties value) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
