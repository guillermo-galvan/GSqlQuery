...
namespace FluentSQL.SearchCriteria
{
    public static class NotBetweenExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> NotBetween<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="final">Final value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndNotBetween<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="final">Final value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrNotBetween<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            TProperties initial, TProperties final) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
