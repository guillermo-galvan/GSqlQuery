...
namespace FluentSQL.SearchCriteria
{
    public static class GreaterThanOrEqualExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> GreaterThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndGreaterThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrGreaterThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            TProperties value) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
