...
namespace FluentSQLTest.Default
{
    public class SetTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new Set<Test1>(null, new List<string> { nameof(Test1.Id) },_statements, null));
            Assert.Throws<ArgumentNullException>(() => new Set<Test1>(new ClassOptions(typeof(Test1)), null, _statements, null));
            ...
            Assert.Throws<InvalidOperationException>(() => new Set<Test1>(new ClassOptions(typeof(Test1)), new List<string> { nameof(Test1.Id) }, _statements, null).Add(x => x.Name));
        }
        ...
        {
            Test1 model = new(1, null, DateTime.Now, true);
            Assert.Throws<ArgumentNullException>(() => new Set<Test1>(null,new ClassOptions(typeof(Test1)), new List<string> { nameof(Test1.Id) }, _statements));
            Assert.Throws<ArgumentNullException>(() => new Set<Test1>(model, null, new List<string> { nameof(Test1.Id) }, _statements));
            Assert.Throws<ArgumentNullException>(() => new Set<Test1>(model, new ClassOptions(typeof(Test1)), null, _statements));
        ...
        {
            Set<Test1> test = new(new ClassOptions(typeof(Test1)), new List<string> { nameof(Test1.Name) },_statements, null);
