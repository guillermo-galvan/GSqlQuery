...
namespace FluentSQL.SearchCriteria
{
    public static class IsNotNullExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> IsNotNull<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndIsNotNull<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrIsNotNull<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression)
            where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
