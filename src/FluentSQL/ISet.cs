...
namespace FluentSQL
{
    ...
    public interface ISet<T, TReturn, TDbConnection, TResult> : IBuilder<TReturn>, ISet ,
        IQueryBuilderWithWhere<T, TReturn, TDbConnection, TResult>
        where T : class, new() where TReturn : IQuery<T, TDbConnection, TResult>
    {
        ...
        /// <param name="value"></param>
        /// <returns>Instance of ISet</returns>
        ISet<T, TReturn, TDbConnection, TResult> Add<TProperties>(Expression<Func<T, TProperties>> expression, TProperties value);
        ...
        /// <param name="expression">The expression representing the property or properties</param>
        /// <returns>Instance of ISet</returns>
        ISet<T, TReturn, TDbConnection, TResult> Add<TProperties>(Expression<Func<T, TProperties>> expression);
    }
}
