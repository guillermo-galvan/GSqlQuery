...
namespace FluentSQLTest.Default
{
    public class BatchQueryTest
    {
        ...
        public void Throw_an_exception_if_null_parameter()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new BatchQuery(null, new ColumnAttribute[] { _columnAttribute }, null, _connectionOptions, insert.GetParameters()));
            Assert.Throws<ArgumentNullException>(() => new BatchQuery(insert.Text, null, null, _connectionOptions, insert.GetParameters()));
            Assert.Throws<ArgumentNullException>(() => new BatchQuery(insert.Text, new ColumnAttribute[] { _columnAttribute }, null, null, insert.GetParameters()));
            Assert.Throws<ArgumentNullException>(() => new BatchQuery(insert.Text, new ColumnAttribute[] { _columnAttribute }, null, _connectionOptions, null));
        }
        ...
        public void Should_execute_the_batches()
        {
            ...
            var result = new BatchQuery(insert.Text, new ColumnAttribute[] { _columnAttribute }, null, _connectionOptions, insert.GetParameters()).Exec();
        ...
        public void Should_execute_the_batches2()
        {
            ...
            var result = new BatchQuery(insert.Text, new ColumnAttribute[] { _columnAttribute }, null, _connectionOptions, insert.GetParameters()).Exec(LoadFluentOptions.GetDbConnection());
