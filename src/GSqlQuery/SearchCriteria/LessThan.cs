...
namespace GSqlQuery.SearchCriteria
{
    ...
    internal class LessThan<T> : Equal<T>
    {
        ...
        public LessThan(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value) :
        ...
        public LessThan(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value, string logicalOperator) :
