...
namespace FluentSQL.SearchCriteria
{
    public static class IsNotNullExtension
    {
        ...
        public static IAndOr<T> IsNotNull<T, TProperties>(this IWhere<T> where, Expression<Func<T, TProperties>> expression) where T : class, new()
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T> AndIsNotNull<T, TProperties>(this IAndOr<T> andOr, Expression<Func<T, TProperties>> expression) where T : class, new()
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Instance of IAndOr</returns>
        public static IAndOr<T> OrIsNotNull<T, TProperties>(this IAndOr<T> andOr, Expression<Func<T, TProperties>> expression) where T : class, new()
        {
            andOr.Validate(expression);
