...
namespace GSqlQuery.SearchCriteria
{
    ...
    internal class NotEqual<T> : Equal<T>, ISearchCriteria
    {
        ...
        public NotEqual(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value) :
        ...
        public NotEqual(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value, string logicalOperator) :
