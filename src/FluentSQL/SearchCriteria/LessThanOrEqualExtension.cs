...
namespace FluentSQL.SearchCriteria
{
    public static class LessThanOrEqualExtension
    {
        ...
        public static IAndOr<T, TReturn, TDbConnection, TResult> LessThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value for equality</param>
        /// <returns>IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> AndLessThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
        ...
        /// <param name="value">Value for equality</param>
        /// <returns>IAndOr</returns>
        public static IAndOr<T, TReturn, TDbConnection, TResult> OrLessThanOrEqual<T, TReturn, TDbConnection, TResult, TProperties>
            (this IAndOr<T, TReturn, TDbConnection, TResult> andOr, Expression<Func<T, TProperties>> expression,
            TProperties value) where T : class, new() where TReturn : IQuery
        {
            andOr.Validate(expression);
