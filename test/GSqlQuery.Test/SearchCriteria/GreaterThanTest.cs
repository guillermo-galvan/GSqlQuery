...
namespace GSqlQuery.Test.SearchCriteria
{
    public class GreaterThanTest
    {
        ...
        {
            GreaterThan<int> equal = new GreaterThan<int>(_tableAttribute, _columnAttribute, 1);
        ...
        {
            GreaterThan<int> equal = new GreaterThan<int>(_tableAttribute, _columnAttribute, value, logicalOperator);
