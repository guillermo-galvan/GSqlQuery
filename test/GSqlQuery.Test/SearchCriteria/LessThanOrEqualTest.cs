...
namespace GSqlQuery.Test.SearchCriteria
{
    public class LessThanOrEqualTest
    {
        ...
        {
            LessThanOrEqual<int> equal = new LessThanOrEqual<int>(_tableAttribute, _columnAttribute, 1);
        ...
        {
            LessThanOrEqual<int> equal = new LessThanOrEqual<int>(_tableAttribute, _columnAttribute, value, logicalOperator);
