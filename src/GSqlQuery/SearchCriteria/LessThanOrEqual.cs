...
namespace GSqlQuery.SearchCriteria
{
    ...
    internal class LessThanOrEqual<T> : Equal<T>
    {
        ...
        public LessThanOrEqual(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value) :
        ...
        public LessThanOrEqual(ClassOptionsTupla<PropertyOptions> classOptionsTupla, IFormats formats, T value, string logicalOperator) :
